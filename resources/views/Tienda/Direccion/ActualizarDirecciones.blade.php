				...
				<div class="box">
					...
					{!! Form::open(['method' => 'PATCH', 'action' => 'DireccionController@update','$direccion->id']) !!}
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" id="apellidos" name="apellidos" value="{{$direccion->apellidos}}"/>
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" id="direccion" name="direccion" value="{{$direccion->direccion}}"/>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<select name="ciudad" id="id_ciudad" class="form-control"value="{{$direccion->cuidad}}">
								<option></option>
							</select>
						</div>
						<div class="form-group">
								<label for="telefono">Telefono <sup>*</sup></label>
								<input class="form-control" type="tel" id="telefono" name="telefono" value="{{$direccion->telefono}}"/>
						</div>
						<div class="clearfix"></div>
						<div class="form-group">
								<label for="movil">Movil<sup>*</sup></label>
								<input class="form-control" type="tel" id="movil" name="movil" value="{{$direccion->movil}}" />
						</div>

						<div class="form-group">
								<label for="informacion">Información adicional</label>
								<textarea class="form-control" id="info" name="informacion" cols="26" rows="3" value="{{$direccion->informacion}}" ></textarea>
							</div>
