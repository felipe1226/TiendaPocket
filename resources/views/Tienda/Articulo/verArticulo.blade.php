...
@section('content')
		...
		var roundMode = 2;
		var static_token = 'b3d858b6cb06fdca65a3e6e786911dc9';
		var token = '29648087114c0cf8997db5f3f2e914fb';
								...
								<div class="primary_block">
									<div class="pb-left-column col-lg-5 col-md-5 col-sm-14 col-xs-12"><!-- product img-->
										<div id="image-block">
											...
											<span id="view_full_size">
												<img id="bigpic" itemprop="image" data-src="url:(../imgArticulos/1513282402_BBDC77-anymore.tv_.jpg)" data-zoom-image="../imgArticulos/1513282402_BBDC77-anymore.tv_.jpg" src="../imgArticulos/{{$articulo[0]->imagen}}"  title="{{$articulo[0]->nombre}}" alt="Aliquam Leberkas" width="auto" height="auto">
											</span>
										</div> <!-- end image-block -->
										<!-- thumbnails -->
										<!-- end views-block -->
									...
									<div class="pb-right-column col-lg-5 col-md-5 col-sm-8 col-xs-12">
										<div class="product-info">
											...
											<span>demo_1</span>
										</div>--><!-- h=displayRightColumnProduct / Product Comments -->
											...
											<ul class="comments_advices">
												<li class="nb-comments">
													<a href="#idTab5" class="reviews">
														<span itemprop="reviewCount">300 Vistas</span>
													</a>
												</li>
											</ul>
										</div>
										...
										<div class="content_prices">
											...
											<div class="price">
												<p class="our_price_display" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													<link itemprop="availability" href="http://schema.org/InStock">																	<span id="our_price_display" itemprop="price product-price">{{$articulo[0]->precio}}</span>
									 										Cop.
										...
										<p class="warning_inline" id="last_quantities" style="display: none">Atención: últimos productos disponibles!</p>
										...
										<div id="short_description_block">
											<label>DESCRIPCIÓN</label>
													<div id="short_description_content" class="rte align_justify" itemprop="description"><p>{{$articulo[0]->descripcion}}</p>
													</div>
												</div> <!-- end short_description_block -->
												<li><a data-toggle="tab" href="#idTab2">Detalles</a></li>
