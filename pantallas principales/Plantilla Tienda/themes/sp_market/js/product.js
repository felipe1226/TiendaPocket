...
function refreshProductImages(id_product_attribute)
{
	...
	{
		$('#thumbs_list .thumbnail_image').hide();
		...
		$('#thumbs_list .thumbnail_image').show();

	 if (parseInt($('#thumbs_list .thumbnail_image:visible').length) != parseInt($('#thumbs_list .thumbnail_image').length))
